(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".courts-photo__slider")) new swiper_core_Swiper(".courts-photo__slider", {
            modules: [ Navigation, Parallax ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            parallax: true,
            navigation: {
                prevEl: ".courts-photo__btn-prev",
                nextEl: ".courts-photo__btn-next"
            },
            on: {}
        });
    }
    ...
    window.onload = function parallax() {
        const parallaxs = document.querySelectorAll("body");
        parallaxs.forEach((parallax => {
            if (parallax) {
                const bg = document.querySelector(".bg-main__background");
                const ball = document.querySelector(".bg-main__ball");
                if (bg || ball) {
                    const speed = .3;
                    ...
                    parallax.addEventListener("mousemove", (e => {
                        ...
                        const coordX = e.pageX - parallaxWidth / 2 - scrollX;
                        const coordY = e.pageY - parallaxHeight / 2 - scrollY;
                    ...
                    function setParallaxItemsStyle(scrollTopProcent) {
                        bg.style.cssText = `transform: translate(0%,${scrollTopProcent / 2}%);`;
                        ball.style.cssText = `transform: translate(0%,-${scrollTopProcent * 5}%);`;
                    }
                }
            }
        }));
